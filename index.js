...
getObj("https://reqres.in/apiERROR.../users").then((response)=>{
...
const getUrlValues = (res) => {
  ...
  let userListWrapper = document.querySelector(".user-list-wrapper")
  userListWrapper.appendChild(usersList)
...
const getErrorMessage = (error) => {
  ...
  let userListWrapper = document.querySelector(".user-list-wrapper")
  userListWrapper.appendChild(ErrorMessage)
}